...
#define _DOLMEN_CONTAINER_CONTAINED_C "\n"
...
#endif
PyMODINIT_FUNC
init_dolmen_container_contained(void)
{
  PyObject *m;
  ...
  if (0) init_dolmen_proxy_proxy();
  
  m = Py_InitModule3("_dolmen_container_contained", 
